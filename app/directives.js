...
FittFinderApp.directive('ngSpinnerBar', ['$rootScope',
    function($rootScope) {
        return {
...
FittFinderApp.directive('dropdownMenuHover', function () {
  return {
...
FittFinderApp.directive('fileModel', ['$parse', function ($parse) {
    return {
    restrict: 'A',
    link: function(scope, element, attrs) {
...
FittFinderApp.directive('ckEditor', function() {
  return {
    require: 'ngModel',
...
FittFinderApp.directive('escapeToPlainText', function() {
     return {
          require: 'ngModel',
