...
if ($bydirect) {
    ...
    if (isset($params['username']) && isset($params['password'])) {
        ...
        if ($validation_flag == 0) {
            $query = "SELECT id AS user_id,role_id,spe_id,braintree_id,email,firstname,lastname,password,profile_image,api_secret,api_created_date,status FROM `users` WHERE `username` = '$user_name' or  `email` = '$user_name'";
                ...
                if ($user_details['status'] == 1) {
                    if ($password == $user_details['password']) {
                        ...
                        $resulted_data = array(
                            ...
                            'spe_id'=>$user_details['spe_id'],
                            'firstname' => $user_details['firstname'],
                            'lastname' => $user_details['lastname'],
                            'braintree_id' => $user_details['braintree_id'],
