    ...
    if ($bydirect) {
        ...
        if ($validation_flag == 0) {
            ...
            if ($validation_flag == 0) {
                ...
                $query_sel = "SELECT `start_date`,`end_date`,`start_time`,`end_time`,`slot_type`,`slot_interval`,`total_slots`,`recurring_type`,`recurring_weeks`,`recurring_months_base`,`recurring_month_date`,`recurring_month_every`,`recurring_month_day` FROM `class_slots` WHERE `id`='".$slot_id."'";
