<?php
     ...
     $bydirect = true;
     if ($bydirect) {
          if (isset($_POST['event_name']) && isset($_POST['id'])) {
               $validation_flag = 0;
               ...
               if ($validation_flag == 0) {
                    ...
                    $query = "UPDATE `events` SET `spe_id`='".$spe_id."', `event_category_id`='" . $event_category_id . "',`event_name`='" . $event_name . "',`event_description`='" . $event_description . "',`event_timezone`='" . $event_timezone . "',`event_location`='" . $event_location . "',`event_address`='" . $event_address . "',`event_city`='" . $event_city . "',`event_state`='" . $event_state . "',`event_country`='" . $event_country . "',`event_zipcode`='" . $event_zipcode . "',`booking_price`='" . $booking_price . "',`is_paid`='" . $is_paid . "',`event_difficulty`='" . $event_difficulty . "',`event_package`='" . $event_package . "',`event_support`='" . $event_support . "',`event_timing`='" . $event_timing . "',`event_medals`='" . $event_medals . "',`event_discount_type`='" . $event_discount_type . "',`event_discount_amount`='" . $event_discount_amount . "',`status`='" . $status . "',`updated`='" . $updated . "'";
                    if($event_start_time == ""){
                         $query .= ",`event_start_time`=NULL";
                    } else {
                         $query .= ",`event_start_time`='" . $event_start_time . "'";
                    }
                    if($event_end_time == ""){
                         $query .= ",`event_end_time`=NULL";
                    } else {
                         $query .= ",`event_end_time`='" . $event_end_time . "'";
                    }
                    if($event_offer_start == "" || $event_discount_type == "0"){
                         $query .= ",`event_offer_start`=NULL";
                    } else {
                         $query .= ",`event_offer_start`='" . $event_offer_start . "'";
                    }
                    if($event_offer_end == "" || $event_discount_type == "0"){
                         $query .= ",`event_offer_end`=NULL";
                    } else {
                         $query .= ",`event_offer_end`='" . $event_offer_end . "'";
                    }
                    if($logo != ""){
                         $query .= ",`event_image`='" . $logo . "' WHERE `id`='".$id."'";
                    } else {
                         $query .= " WHERE `id`='".$id."'";
                    }
